...
control 'Import key from file non-root user' do
  ...
  # Test that the key imported from keyserver can be read from the keyring
  describe bash('sudo -i gpg2 --list-keys') do
    its('exit_status') { should eq 0 }
    its('stdout') { should match(/7D2BAF1CF37B13E2069D6956105BD0E739499BDB/) }
  end
end
