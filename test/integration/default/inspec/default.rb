...
control 'root key' do
  ...
  describe bash('sudo -u root -i gpg2 --homedir /root/.gnupg --list-keys') do
...
control 'User root: Delete public key' do
  ...
  describe bash('sudo -u root -i gpg2 --list-keys 7877AF01696A73C4D02176F2964720FF470F4EDB') do
    ...
    its('stdout') { should_not match(/Chef Generated Default \(foo\) \(generated by Chef\)/) }
  end
end
