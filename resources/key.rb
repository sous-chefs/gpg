...
# Only Ubuntu support the pinetree_mode. And requires it
property :pinentry_mode, [String, FalseClass], default: lazy { node['platform_family'] == 'ubuntu' ? 'loopback' : false },
         description: 'Pinentry mode. Set to loopback on Ubuntu and False (off) for all other platforms.'

property :batch, [TrueClass, FalseClass], default: true,
